//! Full F# engine (lex → parse → AST → semantic).
...
fn profile() -> FullProfile {
    FullProfile {
        ...
        types: &[
            "int", "int16", "int32", "int64", "uint", "uint16", "uint32", "uint64", "float",
            "float32", "double", "decimal", "bool", "byte", "sbyte", "char", "string", "unit",
            "option", "list", "array", "seq",
        ],
        line_comment: Some("//"),
        block_comment: Some(("(*", "*)")),
