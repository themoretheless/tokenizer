...
impl LanguageId {
    ...
    pub const JSON5: Self = Self("json5");
    pub const JSONL: Self = Self("jsonl");
    pub const CSV: Self = Self("csv");
    pub const TSV: Self = Self("tsv");
    pub const INI: Self = Self("ini");
    pub const PROPERTIES: Self = Self("properties");
    pub const LOGFMT: Self = Self("logfmt");
    pub const HCL: Self = Self("hcl");
    pub const SRT: Self = Self("srt");
    pub const VTT: Self = Self("vtt");
    pub const EDN: Self = Self("edn");
    pub const ICS: Self = Self("ics");
