//! Full PowerShell engine (lex → parse → AST → semantic).
...
fn profile() -> FullProfile {
    FullProfile {
        keywords: &[
            "if", "else", "elseif", "foreach", "for", "while", "function", "param", "begin",
            "process", "end", "switch", "return", "throw", "try", "catch", "finally", "filter",
        ],
        types: &[],
        line_comment: Some("#"),
        block_comment: Some(("<#", "#>")),
